...
const AddEv = () => {
    ...
    ////////////////////////////////////////////////
useEffect(()=>{
    let bibi= +newEv.nbQgen+newEv.nbQperso+newEv.nbQspe;
setNewEv({...newEv, nbQtot:bibi })
}
,[newEv.nbQgen, newEv.nbQperso, newEv.nbQspe])
    ////////////////////////////////////////////////
            ...
            <form onSubmit={() => ajouterEvent()}>
                ...
                <div>
                    ...
                    <div id='categ' onChange={(e) => setNewEv({ ...newEv, thème: e.target.value })}>
                        <input type='radio' value='théâtre' name='categ' /> Théâtre <br/>
                        <input type='radio' value='cinéma' name='categ' /> Cinéma<br/>
                        <input type='radio' value='musique' name='categ' /> Musique<br/>
                        <input type='radio' value='jeux' name='categ' /> Jeux<br/>
                        <input type='radio' value='gastronomie' name='categ' /> Gastronomie<br/>
                        <input type='radio' value='sport' name='categ' /> Sport<br/>
                        <input type='radio' value='com' name='categ' /> Commerces locaux<br/>
                ...
                <div>
                    ...
                    <input id="nbQtot" type='number' value={+newEv.nbQtot} readOnly />
                </div>
                <div>
                ...
                <div>
                    ...
                    <div id='taille' onChange={(e) => setNewEv({ ...newEv, taille: +e.target.value })} required>
                        <input type='radio' value={1} name='taille' checked={newEv.taille === 1} /> Affichage basique<br/>
                        <input type='radio' value={2} name='taille' checked={newEv.taille === 2} /> Affichage + visible<br/>
