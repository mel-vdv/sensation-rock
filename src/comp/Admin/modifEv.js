      ...
      <form onSubmit={() => modifierConcours()}>
        ...
        <div>
          ...
          <div id='thème' onChange={(e) => setEvMod({ ...evMod, thème: e.target.value })}>
            <input type='radio' value="musique" name='thème' checked={evMod.thème==="musique"}/> MUSIQUE
            <input type='radio' value="cinéma" name='thème' checked={evMod.thème==="cinéma"} /> CINEMA
            <input type='radio' value="théâtre" name='thème' checked={evMod.thème==="théâtre"} /> THEATRE
            <input type='radio' value="gastronomie" name='thème' checked={evMod.thème==="gastronomie"} /> GASTRONOMIE
            <input type='radio' value="jeux" name='thème' checked={evMod.thème==="jeux"}/> JEUX
            <input type='radio' value="sport" name='thème'checked={evMod.thème==="sport"} /> SPORT
            <input type='radio' value="com" name='thème' checked={evMod.thème==="com"} /> COMMERCES LOCAUX
        ...
        <div>
          ...
          <div id='taille' onChange={(e) => setEvMod({ ...evMod, taille: e.target.value })}>
            <input type='radio' name='taille' value={1} checked={evMod.taille==1} />Affichage basique
            <input type='radio' name='taille' value={2} checked={evMod.taille==2} />Affichage grand
